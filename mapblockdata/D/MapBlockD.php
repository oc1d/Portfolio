...
class MapBlockD extends MapBlock {
    ...
    public function setMapElements(Map &$map) {
        ...
        $mapElement->northElement = new MapDirectionElement(true,'0505N');
        $mapElement->eastElement = new MapDirectionElement(false, '0505E');
        ...
        $mapElement->southElement = new MapDirectionElement(true, 'Kante2X');
        ...
        $mapElement->westElement = new MapDirectionElement(true, '0401W');
        ...
        $mapElement->southElement = new MapDirectionElement(true,'Kante2');
        ...
        // 2 x 5
        $mapElement = new MapElement;
        $mapElement->northElement = new MapDirectionElement(true, 'KanteL');
        ...
        $mapElement->eastElement = new MapDirectionElement(true, '0201E');
