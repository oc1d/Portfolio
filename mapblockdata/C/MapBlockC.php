...
class MapBlockC extends MapBlock {
	...
	public function __construct($startPosX = false, $startPosY = false) {	
	   ...
	   $connection->class = 'D';
	   $connection->direction = Map::SOUTH;	
	...
	public function setMapElements(Map &$map) {
        ...
        $mapElement->eastElement = new MapDirectionElement(true, 'Kante2X');     
        ...
        $mapElement->westElement = new MapDirectionElement(false, '0101W');              
