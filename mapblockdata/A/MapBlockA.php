...
class MapBlockA extends MapBlock {
	...
	public function setMapElements(Map &$map) {
        ...
        $mapElement->northElement = new MapDirectionElement(false,'0505N', true);
        $mapElement->eastElement = new MapDirectionElement(true,'0505E');       
        $mapElement->southElement = new MapDirectionElement(false, '0505S');
        $mapElement->westElement = new MapDirectionElement(false, '0505W', true);             
        ...
        $mapElement->eastElement = new MapDirectionElement(true, '0302E');     
        $mapElement->southElement = new MapDirectionElement(false,'0302S' );
        $mapElement->westElement = new MapDirectionElement(true, '0302W');             
        ...
        // 2 x 1
        $mapElement = new MapElement;
        $mapElement->northElement = new MapDirectionElement(true, 'KanteLX');
        ...
        // 1 x 1
        $mapElement = new MapElement;
        $mapElement->northElement = new MapDirectionElement(false, '0101N');
        $mapElement->eastElement = new MapDirectionElement(false,'0101E');      
        $mapElement->southElement = new MapDirectionElement(true, '0501NX');
        ...
        // 2 x 3
        $mapElement = new MapElement;
        $mapElement->northElement = new MapDirectionElement(true, '0203N');
        $mapElement->eastElement = new MapDirectionElement(false, '0203E');     
        $mapElement->southElement = new MapDirectionElement(true, '0203S');
        ...
        $mapElement->eastElement = new MapDirectionElement(false, '0103E');     
        ...
        $mapElement->westElement = new MapDirectionElement(true, 'Kante2X');             
